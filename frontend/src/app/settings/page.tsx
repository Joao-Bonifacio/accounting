...
export default async function SettingsPage() {
  ...
  return (
    <div className="h-[79vh]">
      {level !== 'PLATINUM' && (
        <div className="m-4 bg-slate-500 dark:bg-slate-800 p-4 rounded-md mt-10 flex justify-between align-center">
          <Button variant="ghost" className="p-4">
            Current level: <span className="font-extrabold">{level}</span>
          </Button>
          <Button className="bg-green-400 hover:bg-green-600 p-4 rounded-md text-gray-800 text-right">
            Upgrade plan
          </Button>
        </div>
      )}

      <div className="w-[1200px] sm:w-[600px] mx-auto text-center bg-slate-500 dark:bg-slate-800 rounded-md p-5 pb-[-500px]">
        <Dialog>
          <form
